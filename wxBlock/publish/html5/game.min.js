...
f){if(d)throw d;var m=c.modules||[],n=f.module,q=[];cc._renderType==cc._RENDER_TYPE_WEBGL?m.splice(0,0,"shaders"):0>m.indexOf("core")&&m.splice(0,0,"core");for(var r=0,s=m.length;r<s;r++){var t=b._getJsListOfModule(n,m[r],e);t&&(q=q.concat(t))}q=q.concat(g);cc.loader.loadJsWithImg(q,function(c){if(c)throw c;b._prepared=!0;a&&a()})}))}};cc.game._initConfig();
...
c.borderBottom="1px solid #cccccc";c.borderRightWidth="0px";c.borderLeftWidth="0px";c.borderTopWidth="0px";c.borderTopStyle="none";c.borderRightStyle="none";c.borderLeftStyle="none";c.padding="0px";c.margin=0}a=cc.isString(a)?a:JSON.stringify(a);b.value=b.value+a+"\r\n";b.scrollTop=b.scrollHeight}};cc._formatString=function(a){if(cc.isObject(a))try{return JSON.stringify(a)}catch(b){return""}else return a};
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var n=arguments[k],q;for(q in n){var r="function"===typeof n[q],s="function"===typeof e[q],t=a.test(n[q]);b&&r&&s&&t?(h.value=ClassManager.compileSuper(n[q],q,g),Object.defineProperty(f,q,h)):r&&s&&t?(h.value=function(a,b){return function(){var c=this._super;this._super=e[a];var d=b.apply(this,
arguments);this._super=c;return d}}(q,n[q]),Object.defineProperty(f,q,h)):r?(h.value=n[q],Object.defineProperty(f,q,h)):f[q]=n[q];if(r){var u,w;if(this.__getters__&&this.__getters__[q]){var r=this.__getters__[q],v;for(v in this.__setters__)if(this.__setters__[v]==r){w=v;break}cc.defineGetterSetter(f,r,n[q],n[w]?n[w]:f[w],q,w)}if(this.__setters__&&this.__setters__[q]){r=this.__setters__[q];for(v in this.__getters__)if(this.__getters__[v]==r){u=v;break}cc.defineGetterSetter(f,r,n[u]?n[u]:f[u],n[q],
...
null;for(var b=this._children,c=0,d=b.length;c<d;c++)if(b[c]._name==a)return b[c];return null},addChild:function(a,b,c){b=void 0===b?a._localZOrder:b;var d,e=!1;cc.isUndefined(c)?(c=void 0,d=a._name):cc.isString(c)?(d=c,c=void 0):cc.isNumber(c)&&(e=!0,d="");cc.assert(a,cc._LogInfos.Node_addChild_3);cc.assert(null===a._parent,"child already added. It can't be added again");this._addChildHelper(a,b,c,d,e)},_addChildHelper:function(a,b,c,d,e){this._children||(this._children=[]);this._insertChild(a,b);
e?a.setTag(c):a.setName(d);a.setParent(this);a.setOrderOfArrival(cc.s_globalOrderOfArrival++);if(this._running&&(a.onEnter(),this._isTransitionFinished))a.onEnterTransitionDidFinish();this._cascadeColorEnabled&&this._enableCascadeColor();this._cascadeOpacityEnabled&&this._enableCascadeOpacity()},removeFromParent:function(a){this._parent&&(null==a&&(a=!0),this._parent.removeChild(this,a))},removeFromParentAndCleanup:function(a){cc.log(cc._LogInfos.Node_removeFromParentAndCleanup);this.removeFromParent(a)},
...
t;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(r=(2*r*f+1)/(2*e),q=r+(2*f-2)/(2*e),s=(2*s*g+1)/(2*d),t=s+(2*g-2)/(2*d)):(r=r*f/e,q=r+f/e,s=s*g/d,t=s+g/d);var u=h[n],w=u.tl,v=u.tr,x=u.bl,u=u.br;w.texCoords.u=r;w.texCoords.v=s;v.texCoords.u=q;v.texCoords.v=s;x.texCoords.u=r;x.texCoords.v=t;u.texCoords.u=q;u.texCoords.v=t;x.vertices.x=n*m;x.vertices.y=0;x.vertices.z=0;u.vertices.x=n*m+m;u.vertices.y=0;u.vertices.z=0;w.vertices.x=n*m;w.vertices.y=this._itemHeight;w.vertices.z=0;v.vertices.x=n*m+m;v.vertices.y=
this._itemHeight;v.vertices.z=0;w.colors=k;v.colors=k;x.colors=k;u.colors=k}0<b&&(c.dirty=!0,a=c.totalQuads,b>a&&c.increaseTotalQuadsWith(b-a))},setString:null,_setStringForCanvas:function(a){a=String(a);var b=a.length;this._string=a;this.width=b*this._itemWidth;this.height=this._itemHeight;if(this._children){a=this._children;for(var b=a.length,c=0;c<b;c++){var d=a[c];d&&!d._lateChild&&(d.visible=!1)}}this.updateAtlasValues();this.quadsToDraw=b},_setStringForWebGL:function(a){a=String(a);var b=a.length;
...
h=g?g.length:0;if(0!==h){var k,m=this._config,n=m.kerningDict,q=m.commonHeight,r=m.fontDefDictionary;for(k=0;k<h-1;k++)10==g.charCodeAt(k)&&f++;var s=q*f,f=-(q-q*f),t=-1;for(k=0;k<h;k++)if(q=g.charCodeAt(k),0!=q)if(10===q)c=0,f-=m.commonHeight;else{var u=n[t<<16|q&65535]||0,w=r[q];if(w){var v=cc.rect(w.rect.x,w.rect.y,w.rect.width,w.rect.height),v=cc.rectPixelsToPoints(v);v.x+=this._imageOffset.x;v.y+=this._imageOffset.y;(t=this.getChildByTag(k))?32===q&&a===cc._RENDER_TYPE_CANVAS?t.setTextureRect(v,
...
this._displayedOpacity),t.setNodeDirty());v=cc.p(c+w.xOffset+0.5*w.rect.width+u,f+(m.commonHeight-w.yOffset)-0.5*v.height*cc.contentScaleFactor());t.setPosition(cc.pointPixelsToPoints(v));c+=w.xAdvance+u;t=q;e<c&&(e=c)}else cc.log("cocos2d: LabelBMFont: character not found "+g[k])}d.width=e;d.height=s;this.setContentSize(cc.sizePixelsToPoints(d))}},updateString:function(a){var b=this._children;if(b)for(var c=0,d=b.length;c<d;c++){var e=b[c];e&&(e.visible=!1)}this._config&&this.createFontChars();a||
this.updateLabel()},getString:function(){return this._initialString},setString:function(a,b){a=String(a);null==b&&(b=!0);null!=a&&cc.isString(a)||(a+="");this._initialString=a;this._setString(a,b)},_setStringForSetter:function(a){this.setString(a,!1)},setCString:function(a){this.setString(a,!0)},updateLabel:function(){this.string=this._initialString;if(0<this._width){for(var a=this._string.length,b=[],c=[],d=1,e=0,f=!1,g=!1,h=-1,k=-1,m=0,n,q=0,r=this._children.length;q<r;q++){for(var s=0;!(n=this.getChildByTag(q+
m+s));)s++;m+=s;if(e>=a)break;var t=this._string[e];g||(k=this._getLetterPosXLeft(n),g=!0);f||(h=k,f=!0);if(10==t.charCodeAt(0)){c.push("\n");b=b.concat(c);c.length=0;f=g=!1;h=k=-1;q--;m-=s;d++;if(e>=a)break;k||(k=this._getLetterPosXLeft(n),g=!0);h||(h=k,f=!0);e++}else if(this._isspace_unicode(t))c.push(t),b=b.concat(c),c.length=0,g=!1,k=-1,e++;else if(this._getLetterPosXRight(n)-h>this._width)if(this._lineBreakWithoutSpaces){this._utf8_trim_ws(c);c.push("\n");b=b.concat(c);c.length=0;f=g=!1;h=k=
-1;d++;if(e>=a)break;k||(k=this._getLetterPosXLeft(n),g=!0);h||(h=k,f=!0);q--}else c.push(t),-1!=b.lastIndexOf(" ")?this._utf8_trim_ws(b):b=[],0<b.length&&b.push("\n"),d++,f=!1,h=-1,e++;else c.push(t),e++}b=b.concat(c);q=b.length;n="";for(e=0;e<q;++e)n+=b[e];n+=String.fromCharCode(0);this._setString(n,!1)}if(this._alignment!=cc.TEXT_ALIGNMENT_LEFT)for(b=e=0,a=this._string.length,c=[],d=0;d<a;d++)if(10==this._string[d].charCodeAt(0)||0==this._string[d].charCodeAt(0))if(q=0,f=c.length,0==f)b++;else{if(n=
e+f-1+b,!(0>n)&&(q=this.getChildByTag(n),null!=q)){q=q.getPositionX()+q._getWidth()/2;g=0;switch(this._alignment){case cc.TEXT_ALIGNMENT_CENTER:g=this.width/2-q/2;break;case cc.TEXT_ALIGNMENT_RIGHT:g=this.width-q}if(0!=g)for(q=0;q<f;q++)(n=e+q+b,0>n||!(n=this.getChildByTag(n)))||(n.x+=g);e+=f;b++;c.length=0}}else c.push(this._string[e])},setAlignment:function(a){this._alignment=a;this.updateLabel()},_getAlignment:function(){return this._alignment},setBoundingWidth:function(a){this._width=a;this.updateLabel()},
...
cc.Menu.create=function(a){var b=arguments.length;0<b&&null==arguments[b-1]&&cc.log("parameters should not be ending with null in Javascript");return 0==b?new cc.Menu:1==b?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};var res={clickNormal:"res/item_normal.jpg",clickSel:"res/item_sel.jpg",mm_Normal:"res/mm_normal.jpg",mm_Sel:"res/mm_sel.jpg",shareText:"res/share.png"},g_resources=[res.clickNormal,res.clickSel,res.shareText];TemplateUtils=function(){var a=!1,b=null,c=null,d=[],e=[],f="",g=[],h="x y width height boundingWidth boundingHeight anchorX anchorY scale scaleX scaleY rotation visible opacity color textAlign verticalAlign fontSize fontName fillStyle".split(" "),k=null,m=function(){var a=arguments,b=a.length;if(1>b)return"";var c=a[0],d=!0;"object"==typeof c&&(c=JSON.stringify(c),d=!1);for(var e=1;e<b;++e){var f=a[e],f="object"==typeof f?JSON.stringify(f):f;if(d)for(;;){var g=null;if("number"==typeof f&&(g=c.match(/(%d)|(%s)/))){c=
c.replace(/(%d)|(%s)/,f);break}c=(g=c.match(/%s/))?c.replace(/%s/,f):c+("    "+f);break}else c+="    "+f}return c},n={DIRECTDATA:function(a){return a.value},STRING:function(a,b){for(var c=[a.value],d,e=0,f=a.variables?a.variables.length:0;e<f;++e)d=a.variables[e],b&&void 0!==b[d]?c.push(b[d]):c.push(null);return m.apply(null,c)},IMAGE:function(a,b){var c=cc.textureCache.getTextureForKey(a.texUrl);c||(c=cc.textureCache.addImage(a.texUrl));c&&b&&b.node instanceof cc.Sprite&&(b.node.setTexture(c),b.node.setTextureRect(cc.rect(0,
0,c.width,c.height)));return c},ANIMATION:function(a,b){var c=null,d=[],e=[],f,g=cc.rect(0,0,0,0),h=a.interval||0.2;if(a.texs&&0<a.texs.length)for(var k=0,m=a.texs.length;k<m;++k)f=cc.textureCache.addImage(a.texs[k]),g.width=f.width,g.height=f.height,c=new cc.SpriteFrame(f,g),d.push(c);else if(a.texUrl){var k=a.row,m=a.col,n,q;f=cc.textureCache.addImage(a.texUrl);g.width=n=Math.floor(f.width/m);g.height=q=Math.floor(f.height/k);for(var A=0;A<k;++A)for(var y=0;y<m;++y)g.x=y*n,g.y=A*q,c=new cc.SpriteFrame(f,
g),d.push(c)}else return c;if(a.sequence)for(k=0,m=a.sequence.length;k<m;++k)g=a.sequence[k],g<d.length&&0<=g&&e.push(d[g]);else e=d;b&&b.node instanceof cc.Sprite&&0<e.length&&b.node.setSpriteFrame(e[0]);return c=new cc.Animation(e,h)},LABEL:function(a,b){for(var c=[a.string],d,e=0,f=a.variables?a.variables.length:0;e<f;++e)d=a.variables[e],b&&void 0!==b[d]?c.push(b[d]):c.push(null);c=m.apply(null,c);return new cc.LabelTTF(c,a.fontName||"Arial",a.fontSize||"12")},SOUND:function(a){return null}},
q={IMAGE:function(a){var b=new cc.Sprite;TemplateUtils.getVariable(a,{node:b});return b},ANIMATION:function(a){var b=new cc.Sprite;a=TemplateUtils.getVariable(a,{node:b});b.runAction(cc.animate(a).repeatForever());return b},LABEL:function(a){return TemplateUtils.getVariable(a)}};return{init:function(d){b=d.templateVars;c=d.scenes;k=new cc.LayerColor(cc.color(0,0,0));a=!0},getTemplateVars:function(){return b},getSceneVars:function(a){return c[a]},getResourcesList:function(){var a,c,d=[];for(c in b)a=
b[c],a.texUrl?d.push(a.texUrl):a.texs&&(d=d.concat(a.texs));return d},registerScene:function(a,b,c){"function"==typeof b&&(d[a]=b);"function"==typeof c&&(e[a]=c)},runScene:function(a){d[a]&&(e[f]&&e[f](),f=a,g.length=0,g.push(f),d[a]())},reloadCurrentScene:function(){this.runScene(f)},pushScene:function(a){d[a]&&f!=a&&(f=a,g.push(f),d[a]())},popScene:function(){if(e[f]){e[f]();var a=g.length-1;0<=a&&g[a]==f&&(g.pop(),f=0<a?g[a-1]:"")}},pauseGame:function(){cc.director.pause()},resumeGame:function(){cc.director.resume()},
getVariable:function(d,e){if(!a)return null;var g=b[d],k,m=null,q=e&&e.node instanceof cc.Node?e.node:null,x={},z,B;(k=n[g.type])&&(m=k(g,e))&&m instanceof cc.Node&&(q=m);if(q){f&&c[f]&&(B=c[f][d]);for(var C=0,D=h.length;C<D;++C){k=h[C];if(B&&void 0!==B[k])z=B[k];else if(void 0!==g[k])z=g[k];else continue;var E=x,A=k,y=void 0;switch(k){case "color":case "fillStyle":y=cc.color(z);break;case "textAlign":case "verticalAlign":y=cc[z];break;default:y=z}E[A]=y}q.attr(x)}return m},showVariable:function(c,
d){if(a){var e=b[c],f;e&&q[e.type]&&(f=q[e.type](c,d));f instanceof cc.Node&&(e=cc.director.getRunningScene(),k.removeAllChildren(!0),e.removeChild(k),k.width=cc.winSize.width,k.height=cc.winSize.height,f.anchorX=0.5,f.anchorY=0.5,f.x=cc.winSize.width/2,f.y=cc.winSize.height/2,k.addChild(f),e.addChild(k,99999))}},hideVariableDemo:function(){if(a){var b=cc.director.getRunningScene();k.removeAllChildren(!0);b.removeChild(k)}}}}();var Block=cc.Sprite.extend({colorStatus:null,clicked:!1,_index:null,ctor:function(){this._super();this.init()},init:function(){this.colorStatus=!1;this._index=this.anchorY=this.anchorX=0;var a=(cc.winSize.width-TemplateUtils.getVariable("numPerLine")-1)/TemplateUtils.getVariable("numPerLine"),b=Block.conputeBlockHeight();this.setTextureRect(cc.rect(0,0,a,b));this.setColor(cc.color(TemplateUtils.getVariable("blockColor")))},getColorStatus:function(){return this.colorStatus},setClickPic:function(){var a=
TemplateUtils.getVariable("block_normal");this.sprite=new cc.Sprite(a);this.sprite.x=this.width/2;this.sprite.y=this.height/2;this.sprite.width>this.width&&(this.sprite.scaleX=this.width/this.sprite.width);this.sprite.height>this.height&&(this.sprite.scaleY=this.height/this.sprite.height);this.addChild(this.sprite);this.colorStatus=!0},click:function(){if(this.colorStatus){var a=TemplateUtils.getVariable("block_sel");this.sprite.initWithTexture(a);this.sprite.width>this.width&&(this.sprite.scaleX=
this.width/this.sprite.width);this.sprite.height>this.height&&(this.sprite.scaleY=this.height/this.sprite.height);this.clicked=!0}},whiteClick:function(a){var b=new cc.Sprite;b.setTextureRect(this.getTextureRect());b.setColor(cc.color(242,21,21));b.x=this.width/2;b.y=this.height/2;var c=cc.Repeat.create(cc.sequence(cc.fadeOut(0.2),cc.fadeIn(0.2)),3),c=cc.sequence(c,cc.delayTime(0.5),cc.callFunc(function(){a&&a()}));b.runAction(c);this.addChild(b)},getClicked:function(){return this.clicked},setIndex:function(a){this._index=
a},getIndex:function(){return this._index}});Block.make=function(){return new Block};Block.conputeBlockHeight=function(){return(cc.winSize.height-TemplateUtils.getVariable("linePerScreen")+1)/TemplateUtils.getVariable("linePerScreen")};var gameLayer=cc.Layer.extend({score:null,welcomeTitle:null,resultTitle:null,shareText:null,listener:null,index:null,curIndex:null,downOffset:null,countOffset:null,downSpeed:null,lineIndex:null,blockList:null,resultLayer:null,gameStatus:null,updateTime:!1,timeDt:0,ctor:function(a){this._super();this.init(a)},init:function(a){this.score=0;this.blockList=[];this.index=this.curIndex=this.countOffset=this.downOffset=0;this.gameStatus=gameStatus.ready;this.downSpeed=TemplateUtils.getVariable("downSpeed");
this.lineIndex=TemplateUtils.getVariable("linePerScreen");var b=cc.LayerColor.create();b.setColor(cc.color(TemplateUtils.getVariable("bgColor")));this.addChild(b);this.blockLayer=cc.Layer.create();cc.sys.isNative||this.blockLayer.bake();this.makeStartLines();this.addChild(this.blockLayer);this.scoreLabel=cc.LabelTTF.create(TemplateUtils.getVariable("gameTime"),"Arial",22);this.scoreLabel.setColor(cc.color(199,100,255));this.scoreLabel.setPosition(cc.pAdd(cc.visibleRect.top,cc.p(0,-100)));this.addChild(this.scoreLabel);
a?this.schedule(this.updateDown):this.initStartUI()},registetBlockListener:function(a){var b=this.getListener();b._index=a._index;cc.eventManager.addListener(b,a)},updateDown:function(a){if(this.gameStatus==gameStatus.start){this.timeDt+=a;if(!this.updateTime){var b=this.scoreLabel.getString(),b=(parseFloat(b)-this.timeDt).toFixed(2);0<b?this.scoreLabel.setString(b+""):this.finishGame();this.timeDt=0}this.updateTime=!this.updateTime}0<this.downOffset&&(a*=this.downSpeed,0>this.downOffset-a?(this.blockLayer.y-=
this.downOffset,this.countOffset+=this.downOffset,this.downOffset=0,cc.sys.isNative||this.blockLayer.bake()):(this.blockLayer.y-=a,this.downOffset-=a,this.countOffset+=a))},getListener:function(){if(null==this.listener){var a=this;this.listener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(b,c){var d=c.getCurrentTarget(),e=b.getLocation();if(d.getIndex()==a.curIndex&&!d.getClicked()&&cc.rectContainsPoint(d.getBoundingBox(),cc.p(e.x,e.y+a.countOffset))){if(a.gameStatus==
gameStatus.ready)a.gameStatus=gameStatus.start;else if(a.gameStatus==gameStatus.pause)return;cc.sys.isNative||a.blockLayer.unbake();d.getColorStatus()?(d.click(),a.downOffset+=d.height+1,a.addScore(),a.lineIndex++,a.curIndex++,a.makeLine(),a.removeLine()):(a.gameStatus=gameStatus.pause,d.whiteClick(function(){a.finishGame()}));return!0}return!1},onTouchMoved:function(a,c){},onTouchEnded:function(a,c){},onTouchCancelled:function(a,c){cc.log("cancel")}});this.listener.retain()}return this.listener.clone()},
addScore:function(){this.score++},makeStartLines:function(){for(var a=Block.conputeBlockHeight(),b=0;b<=this.lineIndex;b++)this.makeBlockLine(b*a+b)},makeLine:function(){var a=Block.conputeBlockHeight();this.makeBlockLine(this.lineIndex*a+this.lineIndex)},makeBlockLine:function(a){for(var b=TemplateUtils.getVariable("numPerLine"),c=tools.random(0,b-1),d=0;d<b;d++){var e=Block.make();e.retain();e.y=a+1;e.x=0!=d?e.width*d+d:0;d==c&&e.setClickPic();this.blockLayer.addChild(e);this.blockList.push(e);
e.setIndex(this.index);this.registetBlockListener(e)}this.index++},removeLine:function(){for(var a=0;a<this.blockList.length;a++){var b=this.blockList[a];if(0>=b.y-this.countOffset+b.height+10)b.release(),b.removeFromParent(!0),this.blockList.splice(a,1);else break}},initStartUI:function(){this.resultLayer=cc.LayerColor.create();this.resultLayer.setColor(cc.color(0,159,227));this.addChild(this.resultLayer);var a=cc.LabelTTF.create(TemplateUtils.getVariable("startTitle"),"Arial",25);a.setColor(cc.color(255,
255,255));a.setPosition(cc.pAdd(cc.visibleRect.top,cc.p(0,-50)));this.resultLayer.addChild(a);a=TemplateUtils.getVariable("gameTime");a=cc.LabelTTF.create(TemplateUtils.getVariable("startContent",{number:a}),"Arial");a.setColor(cc.color(255,255,255));a.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,50)));a.setDimensions(cc.size(cc.winSize.width-60,150));this.resultLayer.addChild(a);var b=cc.LabelTTF.create("\u5206\u4eab\u7ed9\u597d\u53cb","Arial",25),a=cc.LabelTTF.create("\u5f00\u59cb\u73a9\u6e38\u620f",
"Arial",25),b=cc.MenuItemLabel.create(b,this.shareGame,this),a=cc.MenuItemLabel.create(a,this.startGame,this),a=cc.Menu.create(a,b);a.alignItemsVerticallyWithPadding(20);a.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,-100)));this.resultLayer.addChild(a);share(0)},startGame:function(){this.resultLayer.removeFromParent(!0);this.schedule(this.updateDown)},finishGame:function(){this.unschedule(this.updateDown);this.resultLayer=cc.LayerColor.create();this.resultLayer.setColor(cc.color(0,159,227));
this.addChild(this.resultLayer);var a=cc.LabelTTF.create(TemplateUtils.getVariable("resultTitle",{score:this.score}),"Arial",22);a.setColor(cc.color(255,255,255));a.setPosition(cc.pAdd(cc.visibleRect.top,cc.p(0,-50)));this.resultLayer.addChild(a);a=tools.random(1,10);a=cc.LabelTTF.create(TemplateUtils.getVariable("resultContent",{number:a}),"Arial");a.setColor(cc.color(255,255,255));a.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,50)));a.setDimensions(cc.size(cc.winSize.width-60,150));this.resultLayer.addChild(a);
a=cc.LabelTTF.create("\u6218\u7ee9\uff1a"+this.score,"Arial",25);a.setColor(cc.color(244,9,68));a.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,-30)));this.resultLayer.addChild(a);var b=cc.LabelTTF.create("\u5206\u4eab\u7ed9\u597d\u53cb","Arial",25),a=cc.LabelTTF.create("\u91cd\u65b0\u5f00\u59cb\u73a9","Arial",25),b=cc.MenuItemLabel.create(b,this.shareGame,this),a=cc.MenuItemLabel.create(a,this.restartGame,this),a=cc.Menu.create(a,b);a.alignItemsVerticallyWithPadding(20);a.setPosition(cc.pAdd(cc.visibleRect.center,
cc.p(0,-100)));this.resultLayer.addChild(a);share(1,this.score)},shareGame:function(){var a=cc.LayerColor.create();a.setColor(cc.color(0,159,227));var b=cc.Sprite.create(res.shareText);b.setScale(0.25);a.addChild(b);b.setPosition(cc.pAdd(cc.visibleRect.topRight,cc.p(-b.width/7,-b.height/8)));this.addChild(a,111);var c=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(b,e){a.isVisible()&&(a.visible=!1,a.removeFromParent(!0));cc.eventManager.removeListener(c);
return!0}});cc.eventManager.addListener(c,a)},restartGame:function(){cc.director.runScene(new gameScene(!0));share(0)},onExit:function(){this._super();this.listener.release()}}),gameScene=cc.Scene.extend({status:!1,ctor:function(a){this._super();this.status=a},onEnter:function(){this._super();var a=new gameLayer(this.status);this.addChild(a)}}),tools={random:function(a,b){return parseInt(Math.random()*(b+1-a)+a)}},gameStatus={stop:0,start:1,pause:2,ready:3};
function share(a,b){cc.sys.isNative||(0==a&&(document.title=window.wxData.desc=TemplateUtils.getVariable("shareBefore")),1==a&&(document.title=window.wxData.desc=TemplateUtils.getVariable("shareAfter",{number:b})))};cc.sys.isNative&&require("template-utils.js");cc.game.onStart=function(){cc.view.setDesignResolutionSize(321,500,cc.sys.isNative?cc.ResolutionPolicy.FIXED_HEIGHT:cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.loader.loadJson("template.json",function(a,b){a?cc.error("Template parse failed"):(TemplateUtils.init(b),g_resources=g_resources.concat(TemplateUtils.getResourcesList()));cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new gameScene)},this)},this)};cc.game.run();
