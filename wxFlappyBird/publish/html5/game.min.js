...
arguments);this._super=c;return d}}(q,n[q]),Object.defineProperty(f,q,h)):s?(h.value=n[q],Object.defineProperty(f,q,h)):f[q]=n[q];if(s){var u,w;if(this.__getters__&&this.__getters__[q]){var s=this.__getters__[q],v;for(v in this.__setters__)if(this.__setters__[v]==s){w=v;break}cc.defineGetterSetter(f,s,n[q],n[w]?n[w]:f[w],q,w)}if(this.__setters__&&this.__setters__[q]){s=this.__setters__[q];for(v in this.__getters__)if(this.__getters__[v]==s){u=v;break}cc.defineGetterSetter(f,s,n[u]?n[u]:f[u],n[q],
...
d){if(a){var e=b[c],f;e&&q[e.type]&&(f=q[e.type](c,d));f instanceof cc.Node&&(e=cc.director.getRunningScene(),k.removeAllChildren(!0),e.removeChild(k),k.width=cc.winSize.width,k.height=cc.winSize.height,f.anchorX=0.5,f.anchorY=0.5,f.x=cc.winSize.width/2,f.y=cc.winSize.height/2,k.addChild(f),e.addChild(k,99999))}},hideVariableDemo:function(){if(a){var b=cc.director.getRunningScene();k.removeAllChildren(!0);b.removeChild(k)}}}}();var res={s_mainBg:"res/bg.png",s_ground:"res/ground.png",s_flappy_packer_png:"res/flappy_packer.png",s_flappy_packer_plist:"res/flappy_packer.plist",s_flappy_frame_plist:"res/flappy_frame.plist",s_sfx_die_ogg:"res/sounds/sfx_die.ogg",s_sfx_hit_ogg:"res/sounds/sfx_hit.ogg",s_sfx_point_ogg:"res/sounds/sfx_point.ogg",s_sfx_swooshin_ogg:"res/sounds/sfx_swooshing.ogg",s_sfx_winge_ogg:"res/sounds/sfx_wing.ogg",s_temp_json:"template.json"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var CrazyBird={random:function(a,b){return parseInt(Math.random()*(b-a)+a)},MOVESPEED:300,LINEPIPE:2E3,GROUND:2001,BIRD:2002,SCORE:2003,MENU:2004,GAMESTATUS:{}};CrazyBird.GAMESTATUS.NORMAL=1;CrazyBird.GAMESTATUS.LOST=0;CrazyBird.GAMESTATUS.PAUSE=2;CrazyBird.GAMESTATUS.WAITFORLOST=3;CrazyBird.GAMESTATUS.NOWSTATUS=CrazyBird.GAMESTATUS.PAUSE;CrazyBird.AUIDIO={};CrazyBird.AUIDIO.PLAYMUSIC=!1;CrazyBird.scaleFactor=1;var audioMng=cc.Class.extend({ctor:function(){this.audio=cc.audioEngine},playMusic:function(a,b){CrazyBird.AUIDIO.PLAYMUSIC&&this.audio.playMusic(a,b)},stopMusic:function(){(CrazyBird.AUIDIO.PLAYMUSIC||this.audio.isMusicPlaying())&&this.audio.stopMusic()},pauseMusic:function(){(CrazyBird.AUIDIO.PLAYMUSIC||this.audio.isMusicPlaying())&&this.audio.pauseMusic()},playEffect:function(a,b){if(CrazyBird.AUIDIO.PLAYMUSIC)return this.audio.playEffect(a,b)},pauseEffect:function(a){CrazyBird.AUIDIO.PLAYMUSIC&&
this.audio.pauseEffect(a)},stopEffect:function(a){CrazyBird.AUIDIO.PLAYMUSIC&&this.audio.stopEffect(a)}});audioMng._instance=null;audioMng.getInstance=function(){audioMng._instance||(audioMng._instance=new audioMng);return audioMng._instance};var Bird_Fly_Tag=1E3,Bird_Move_Tag=1001,Bird=cc.Sprite.extend({gravity:1200,velocity:0,nowTime:0,maxWidth:60,maxHeight:60,scaleX:1,scaleY:1,ctor:function(a){this._super();this.gameLayer=a;this.init();this.setAnchorPoint(cc.p(0.5,0.5))},init:function(){this.size=cc.winSize;var a=TemplateUtils.getVariable("bridPhoto");TemplateUtils.getVariable("bridPhoto");this.initWithTexture(a);this.width>this.maxWidth&&(this.scaleX=this.maxWidth/this.width);this.height>this.maxHeight&&(this.scaleY=this.maxHeight/
this.height);this.__height=this.height*this.scaleY;this.initAnim()},initAnim:function(){var a=cc.MoveBy.create(0.25,cc.p(0,15)),b=cc.MoveBy.create(0.25,cc.p(0,0)),c=cc.MoveBy.create(0.25,cc.p(0,-15)),d=cc.MoveBy.create(0.25,cc.p(0,0)),a=cc.Sequence.create(a,b,c,d),a=cc.RepeatForever.create(a);a.setTag(Bird_Move_Tag);this.runAction(a)},fly:function(){audioMng.getInstance().playEffect(res.s_sfx_winge_ogg);this.getPosition().y<=this.size.height&&(this.velocity=-750,this.nowTime=0)},startGravity:function(){this.stopActionByTag(Bird_Move_Tag)},
getCollideBox:function(){return cc.rect(this.x-this.width*this.scaleX/4,this.y-this.height*this.scaleY/4,this.width/4*3*this.scaleX,this.height/4*3*this.scale)},update:function(a){if(this.getPosition().y>=GROUND_HEIGHT+this.__height/2+8){var b=this.velocity*(this.nowTime+a)+this.gravity*(this.nowTime+a)*(this.nowTime+a)/2-this.velocity*this.nowTime-this.gravity*this.nowTime*this.nowTime/2;this.velocity+=this.gravity*a;this.nowTime+=a;0>this.velocity?(a=this.velocity/18,this.setRotation(a)):(a=this.velocity/
3,90>=a&&this.setRotation(a));this.setPosition(cc.p(this.getPosition().x,this.getPosition().y-b))}else this.stopActionByTag(Bird_Fly_Tag),this.gameLayer.lostGame()}});Bird.create=function(a){return new Bird(a)};var PipeLine=cc.Sprite.extend({score:!1,maxWidth:130,maxHeight:700,__height:null,scaleX:1,scaleY:1,ctor:function(a){this._super();this.init(a)},init:function(a){this.initWithTexture(TemplateUtils.getVariable("pineLine"));2==a&&this.setFlippedY(!0);this.setAnchorPoint(cc.p(0,0));this.width>this.maxWidth&&(this.scaleX=this.maxWidth/this.width);this.height>this.maxHeight&&(this.scaleY=this.maxHeight/this.height)},getSize:function(){return cc.size(this.width*this.scaleX,this.height*this.scaleY)},getCollideBox:function(){return cc.rect(this.x,
this.y,this.width*this.scaleX,this.height*this.scaleY)},setScored:function(){this.score=!0},isScore:function(){return this.score}});PipeLine.create=function(a){return new PipeLine(a)};var PipeLineController=cc.Class.extend({createDistance:390,nowDistance:0,spaceHeight:230,minHeight:360,ctor:function(a){this.gameLayer=a;this.init()},init:function(){this.pipeArray=[];this.pipeMidArray=[];this.createPipe()},createPipe:function(){var a=PipeLine.create(1),b=PipeLine.create(2),c=CrazyBird.random(0,this.minHeight);a.setPosition(cc.p(this.gameLayer.size.width+10,-c));b.setPosition(cc.p(this.gameLayer.size.width+10,this.spaceHeight+a.getSize().height+a.getPosition().y));this.addPipeToGame(a,
b)},addPipeToGame:function(a,b){if(a,b)this.gameLayer.addChild(a,CrazyBird.LINEPIPE),this.gameLayer.addChild(b,CrazyBird.LINEPIPE),this.pipeArray.push(a),this.pipeArray.push(b)},makePipe:function(a){this.nowDistance+=CrazyBird.MOVESPEED*a;this.nowDistance>this.createDistance&&(this.nowDistance=0,this.createPipe());for(var b=0;b<this.pipeArray.length;b++){var c=this.pipeArray[b],d=c.getPosition(),e=c.getSize();c.setPosition(cc.p(d.x-CrazyBird.MOVESPEED*a,d.y));var f=this.gameLayer.bird.getPosition();
!c.isScore()&&f.x>=d.x&&f.x<=d.x+e.width&&(this.gameLayer.addScore(),c.setScored());0>d.x+e.width&&c.setVisible(!1)}for(b=0;b<this.pipeArray.length;b++)c=this.pipeArray[b],c.isVisible()||this.pipeArray.splice(b,1);this.checkCrash(a)},checkCrash:function(a){for(a=0;a<this.pipeArray.length;a++){var b=this.pipeArray[a];cc.rectIntersectsRect(this.gameLayer.bird.getCollideBox(),b.getCollideBox())&&(CrazyBird.GAMESTATUS.NOWSTATUS=CrazyBird.GAMESTATUS.WAITFORLOST,audioMng.getInstance().playEffect(res.s_sfx_hit_ogg),
audioMng.getInstance().playEffect(res.s_sfx_die_ogg))}}});PipeLineController.create=function(a){return new PipeLineController(a)};var GROUND_HEIGHT=0,Ground=cc.Sprite.extend({ctor:function(){this._super();this.star()},star:function(){this.initWithTexture(TemplateUtils.getVariable("ground"));this.setAnchorPoint(cc.p(0,0));GROUND_HEIGHT||(GROUND_HEIGHT=this.height)},destory:function(){this.removeFromParent(!0)}});Ground.create=function(){return new Ground};var GroundController=cc.Class.extend({ctor:function(a){this.gameLayer=a;this.init()},init:function(){this.groundArray=[];var a=Ground.create(),b=Ground.create();a.setPosition(cc.p(0,0));b.setPosition(cc.p(a.getContentSize().width,0));this.addGroundToGame(a);this.addGroundToGame(b)},addGroundToGame:function(a){a&&(this.gameLayer.addChild(a,CrazyBird.GROUND),this.groundArray.push(a))},makeGround:function(a){if(!(0>=this.groundArray.length)){for(var b=0;b<this.groundArray.length;b++){var c=this.groundArray[b],
d=c.getPosition(),e=c.getContentSize();0>d.x+e.width?(c.setVisible(!1),c=Ground.create(),d=this.groundArray[this.groundArray.length-1],d=d.getPosition().x+d.getContentSize().width,c.setPosition(cc.p(d,0)),this.addGroundToGame(c)):c.setPosition(cc.p(d.x-CrazyBird.MOVESPEED*a,d.y))}for(b=0;b<this.groundArray.length;b++)c=this.groundArray[b],c.isVisible()||(c.destory(),this.groundArray.splice(b,1))}}});GroundController.create=function(a){return new GroundController(a)};var gameLayer=cc.Layer.extend({score:0,init:function(){this._super();this.size=cc.winSize;this.preFrames();var a=cc.Sprite.create(TemplateUtils.getVariable("background"));this.addChild(a);a.setPosition(cc.p(0,0));a.setAnchorPoint(cc.p(0,0));this.bird=Bird.create(this);this.addChild(this.bird,CrazyBird.BIRD);this.bird.setPosition(cc.p(this.size.width/6,this.size.height/2));this.PipeLineController=PipeLineController.create(this);this.GroundController=GroundController.create(this);this.scoreLabel=cc.LabelTTF.create("0",
"Arial",72);this.scoreLabel.setPosition(cc.p(this.size.width/2,this.size.height-200));this.addChild(this.scoreLabel,CrazyBird.SCORE);this.tableSprite=cc.Sprite.create("#click.png");this.addChild(this.tableSprite,CrazyBird.MENU);this.tableSprite.setPosition(cc.p(this.size.width/2,this.size.height/2));this.addTouch()},addTouch:function(){var a=this;this.listener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(b,c){return a.onTouchBegan(b,c)},
onTouchMoved:function(b,c){a.onTouchMoved(b,c)},onTouchEnded:function(b,c){a.onTouchEnded(b,c)},onTouchCancelled:function(a,c){}});cc.eventManager.addListener(this.listener,a)},startGame:function(){CrazyBird.GAMESTATUS.NOWSTATUS=CrazyBird.GAMESTATUS.NORMAL;this.tableSprite.setVisible(!1);this.schedule(this.update);this.bird.startGravity();share(0)},lostGame:function(){CrazyBird.GAMESTATUS.NOWSTATUS=CrazyBird.GAMESTATUS.LOST;this.lostSprite=cc.Sprite.create("#gameover.png");this.lostSprite.setPosition(cc.p(this.size.width/
2,this.size.height/2));this.addChild(this.lostSprite,CrazyBird.MENU);this.unschedule(this.update);share(1,this.score)},reStartGame:function(){CrazyBird.GAMESTATUS.NOWSTATUS=CrazyBird.GAMESTATUS.PAUSE;var a=new GameScene;cc.director.runScene(a)},addScore:function(){this.score+=0.5;var a=Math.floor(this.score);(a=this.score)&&audioMng.getInstance().playEffect(res.s_sfx_point_ogg);this.scoreLabel.setString(a)},preFrames:function(){cc.spriteFrameCache.addSpriteFrames(res.s_flappy_packer_plist)},onTouchBegan:function(a,
b){CrazyBird.GAMESTATUS.NOWSTATUS==CrazyBird.GAMESTATUS.PAUSE?(this.startGame(),this.bird.fly()):CrazyBird.GAMESTATUS.NOWSTATUS==CrazyBird.GAMESTATUS.NORMAL?this.bird.fly():CrazyBird.GAMESTATUS.NOWSTATUS==CrazyBird.GAMESTATUS.LOST&&this.reStartGame();return!0},onTouchMoved:function(a,b){},onTouchEnded:function(a,b){},update:function(a){CrazyBird.GAMESTATUS.NOWSTATUS==CrazyBird.GAMESTATUS.NORMAL&&(this.GroundController.makeGround(a),this.PipeLineController.makePipe(a));this.bird.update(a)}}),GameScene=
cc.Scene.extend({onEnter:function(){this._super();var a=new gameLayer;this.addChild(a);a.init()}});function share(a,b){cc.sys.isNative||(0==a&&(document.title=window.wxData.desc=TemplateUtils.getVariable("shareBefore")),1==a&&(document.title=window.wxData.desc=TemplateUtils.getVariable("shareAfter",{number:b})))};cc.game.onStart=function(){cc.view.adjustViewPort(!0);cc.sys.isMobile?cc.view.setDesignResolutionSize(720,1280,cc.ResolutionPolicy.FIXED_WIDTH):cc.view.setDesignResolutionSize(720,1280,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.loader.loadJson("template.json",function(a,b){a?cc.error("Template parse failed"):(TemplateUtils.init(b),g_resources=g_resources.concat(TemplateUtils.getResourcesList()));cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new GameScene)},
